...
static void draw_instructions(player_data_t *plyr)
{
    ...
    case -1:
        ...
        print_instruction(Localize("Good job. Now you're ready for the races!", ""), 0);
    ...
    case 22:
        ...
        if (check_condition_for_time((bool_t)(plyr->control.is_flying && plyr->control.is_accelerating), 1000))
            step = -2;
        break;
    case -2:
