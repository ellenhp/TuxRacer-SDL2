...
void ssbutton_draw(ssbutton_t *ssbutton) {
  ...
  button_set_image(ssbutton->button, ssbutton->regions[i].binding,
                   ssbutton->regions[i].ll, ssbutton->regions[i].ur,
                   ssbutton->regions[i].colour);
  button_set_disabled_image(ssbutton->button, ssbutton->regions[i].binding,
                            ssbutton->regions[i].ll, ssbutton->regions[i].ur,
...
static void ssbutton_button_click_event_cb(button_t *button, void *userdata) {
  ...
  ssbutton->current_state =
      (ssbutton->current_state + 1) % ssbutton->num_states;
}
...
ssbutton_t *ssbutton_create(point2d_t pos, scalar_t w, scalar_t h,
  ...
  button_set_click_event_cb(ssbutton->button, ssbutton_button_click_event_cb,
                            ssbutton);
...
/*!
  ...
  \date    Modified: 2000-09-19
*/
void ssbutton_set_state_image(ssbutton_t *ssbutton, int state, char *binding,
                              point2d_t ll, point2d_t ur, colour_t colour) {
  check_assertion(ssbutton != NULL, "ssbutton is NULL");
...
*/
void ssbutton_set_hilit_image(ssbutton_t *ssbutton, char *binding, point2d_t ll,
                              point2d_t ur, colour_t colour) {
  check_assertion(ssbutton != NULL, "ssbutton is NULL");
