...
typedef enum { WS_MOUSE_DOWN, WS_MOUSE_UP } winsys_button_state_t;
...
typedef void (*winsys_mouse_func_t)(int button, int state, int finger_index,
                                    int x, int y);
...
void winsys_perform_on_main_thread_sync2(void (*func)(void *, void *),
                                         void *arg1, void *arg2);
