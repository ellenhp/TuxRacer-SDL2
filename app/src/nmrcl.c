...
const double ode23_coeff_mat[][4] = {{0., 1. / 2., 0., 2. / 9.},
                                     {0., 0., 3. / 4., 1. / 3.},
                                     {0., 0., 0., 4. / 9.},
                                     {0., 0., 0., 0.}};
...
const double ode45_time_step_mat[] = {0.,      1. / 5., 3. / 10., 4. / 5.,
                                      8. / 9., 1.,      1.};
const double ode45_coeff_mat[][7] = {
    {0, 1. / 5., 3. / 40., 44. / 45., 19372. / 6561., 9017. / 3168.,
     35. / 384.},
...
int euler_num_estimates() { return 2; }
...
int ode23_num_estimates() { return 4; }
...
double ode23_time_step_exponent() { return ode23_time_step_exp; }
...
int ode45_num_estimates() { return 7; }
...
double ode45_time_step_exponent() { return ode45_time_step_exp; }
...
double lin_interp(const double x[], const double y[], double val, int n) {
  ...
  check_assertion(n >= 2,
                  "linear interpolation requires at least two data points");
