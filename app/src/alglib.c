...
void multiply_matrices(matrixgl_t ret, matrixgl_t mat1, matrixgl_t mat2) {
  ...
  for (i = 0; i < 4; i++)
    for (j = 0; j < 4; j++)
      r[j][i] = mat1[0][i] * mat2[j][0] + mat1[1][i] * mat2[j][1] +
...
void make_translation_matrix(matrixgl_t mat, scalar_t x, scalar_t y,
                             scalar_t z) {
  make_identity_matrix(mat);
  mat[3][0] = x;
  mat[3][1] = y;
 ...
 */
void make_change_of_basis_matrix(matrixgl_t mat, matrixgl_t invMat, vector_t w1,
                                 vector_t w2, vector_t w3) {
  make_identity_matrix(mat);
  mat[0][0] = w1.x;
  mat[0][1] = w1.y;
  mat[0][2] = w1.z;
...
void make_rotation_about_vector_matrix(matrixgl_t mat, vector_t u,
                                       scalar_t angle) {
...
void cut_line(point_t p1, point_t p2, point2d_t t1, point2d_t t2,
              scalar_t ratio, point_t *result, point2d_t *result_tex) {
  ...
  if (side0 > 0) {
    if (side1 > 0) {
      ...
      if (side2 >= 0) {
        ...
        out_tri2->p[2] = in_tri->p[0];
        out_tri2->t[2] = in_tri->t[0];
        out_tri3->p[0] = out_tri2->p[1];
        out_tri3->t[0] = out_tri2->t[1];
        out_tri3->p[1] = out_tri2->p[0];
        out_tri3->t[1] = out_tri2->t[0];
        out_tri3->p[2] = in_tri->p[2];
        out_tri3->t[2] = in_tri->t[2];
        result = 3;
      }
      ...
      if (side2 >= 0) {
        ...
        out_tri2->p[0] = out_tri1.p[2];
        out_tri2->t[0] = out_tri1.t[2];
        out_tri2->p[1] = in_tri->p[1];
        out_tri2->t[1] = in_tri->t[1];
        out_tri2->p[2] = in_tri->p[2];
        out_tri2->t[2] = in_tri->t[2];
        result = 2;
      }

    } else { /* (side1 < 0) */
      cut_line(in_tri->p[0], in_tri->p[1], in_tri->t[0], in_tri->t[1], ratio01,
               &out_tri1.p[1], &out_tri1.t[1]);
      if (side2 > 0) {
        out_tri1.p[2] = in_tri->p[2];
        out_tri1.t[2] = in_tri->t[2];
        out_tri2->p[0] = in_tri->p[2];
        out_tri2->t[0] = in_tri->t[2];
        out_tri2->p[1] = out_tri1.p[1];
        out_tri2->t[1] = out_tri1.t[1];
        cut_line(in_tri->p[1], in_tri->p[2], in_tri->t[1], in_tri->t[2],
                 ratio12, &out_tri2->p[2], &out_tri2->t[2]);
        out_tri3->p[0] = out_tri2->p[1];
        out_tri3->t[0] = out_tri2->t[1];
        out_tri3->p[1] = in_tri->p[1];
        out_tri3->t[1] = in_tri->t[1];
        out_tri3->p[2] = out_tri2->p[2];
        out_tri3->t[2] = out_tri2->t[2];
        result = 3;
      } else if (side2 == 0) {
        out_tri1.p[2] = in_tri->p[2];
        out_tri1.t[2] = in_tri->t[2];
        out_tri2->p[0] = out_tri1.p[1];
        out_tri2->t[0] = out_tri1.t[1];
        out_tri2->p[1] = in_tri->p[1];
        out_tri2->t[1] = in_tri->t[1];
        out_tri2->p[2] = in_tri->p[2];
        out_tri2->t[2] = in_tri->t[2];
        ...
        out_tri2->p[2] = in_tri->p[2];
        out_tri2->t[2] = in_tri->t[2];
        out_tri3->p[0] = in_tri->p[1];
        out_tri3->t[0] = in_tri->t[1];
        out_tri3->p[1] = in_tri->p[2];
        out_tri3->t[1] = in_tri->t[2];
        out_tri3->p[2] = out_tri1.p[1];
        out_tri3->t[2] = out_tri1.t[1];
        result = 3;
      }
    }
    ...
    if (((side1 > 0) && (side2 > 0)) || ((side1 < 0) && (side2 < 0))) {
      ...
      cut_line(in_tri->p[1], in_tri->p[2], in_tri->t[1], in_tri->t[2], ratio12,
               &out_tri1.p[2], &out_tri1.t[2]);
      out_tri2->p[0] = in_tri->p[0];
