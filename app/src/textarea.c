...
static void calc_text_region_dims(textarea_t *ta) {
  ...
  ta->text_region_width =
      ta->w - 2 * ta->border_width - 2 * ta->text_pad - ta->arrow_width;
...
static void create_lines(textarea_t *ta) {
  ...
  while (*cur_ptr != '\0') {
    ...
    if (old_space_ptr == NULL) {
      ...
      */
      cur_line =
          insert_list_elem(ta->line_list, cur_line, (list_elem_data_t)cur_ptr);
...
void textarea_draw(textarea_t *ta) {
  ...
  GLfloat border_vertices[] = {ta->pos.x,         ta->pos.y,         0,
                               ta->pos.x,         ta->pos.y + ta->h, 0,
                               ta->pos.x + ta->w, ta->pos.y + ta->h, 0,
                               ta->pos.x + ta->w, ta->pos.y,         0};

  GLfloat background_vertices[] = {ta->pos.x + ta->border_width,
                                   ta->pos.y + ta->border_width,
                                   ta->pos.x + ta->border_width,
...
static void update_button_positions(textarea_t *ta) {
  ...
  button_set_position(ta->up_button,
                      make_point2d(ta->pos.x + ta->w - ta->border_width -
                                       button_get_width(ta->up_button),
                                   ta->pos.y + ta->h - ta->border_width -
                                       button_get_height(ta->up_button)));
  button_set_position(ta->down_button,
                      make_point2d(ta->pos.x + ta->w - ta->border_width -
