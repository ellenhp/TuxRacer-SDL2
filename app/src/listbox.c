...
static void update_button_positions(listbox_t *listbox) {
  ...
  button_set_position(
      listbox->up_button,
      make_point2d(listbox->pos.x + listbox->w + listbox->arrow_separation,
                   listbox->pos.y - DEFAULT_ARROW_BUTTON_HEIGHT));
...
static void listbox_arrow_click_cb(button_t *button, void *userdata) {
  ...
  if (button == listbox->up_button) {
    listbox->cur_item =
        get_prev_list_elem(listbox->item_list, listbox->cur_item);
  } else if (button == listbox->down_button) {
    listbox->cur_item =
        get_next_list_elem(listbox->item_list, listbox->cur_item);
...
#ifdef HAVE_OPENGLES
              glColor4x( listbox->border_colour.r, listbox->border_colour.g,
listbox->border_colour.b, listbox->border_colour.a ); #else glColor4d(
listbox->border_colour.r, listbox->border_colour.g, listbox->border_colour.b,
listbox->border_colour.a ); #endif glEnableClientState (GL_VERTEX_ARRAY);
      glVertexPointer (2, GL_FLOAT , 0, vertices_box);
      glDrawArrays(GL_TRIANGLE_STRIP, 0, 4);

#ifdef HAVE_OPENGLES
              glColor4x( listbox->background_colour.r,
listbox->background_colour.g, listbox->background_colour.b,
listbox->background_colour.a ); #else glColor4d( listbox->background_colour.r,
listbox->background_colour.g, listbox->background_colour.b,
listbox->background_colour.a ); #endif
...
listbox_t *listbox_create(point2d_t pos, scalar_t w, scalar_t h,
  ...
  listbox->up_button = button_create(
      ...
      DEFAULT_ARROW_BUTTON_WIDTH, DEFAULT_ARROW_BUTTON_HEIGHT, NULL, NULL);
  ...
  button_set_click_event_cb(listbox->up_button, listbox_arrow_click_cb,
                            listbox);
  ...
  button_set_click_event_cb(listbox->down_button, listbox_arrow_click_cb,
                            listbox);
...
*/
void listbox_set_item_list(listbox_t *listbox, list_t item_list,
                           listbox_list_elem_to_string_fptr_t func) {
  check_assertion(listbox != NULL, "listbox is NULL");
