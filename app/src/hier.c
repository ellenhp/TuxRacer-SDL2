...
static int add_scene_node(const char *parent_name, const char *node_name,
                          scene_node_t *node) {
  Tcl_HashEntry *entry;
  int newEntry;
  char new_name[1024];
...
const char *reset_scene_node(const char *node) {
...
const char *rotate_scene_node(const char *node, char axis, scalar_t angle) {
  scene_node_t *nodePtr;
...
const char *translate_scene_node(const char *node, vector_t vec) {
  scene_node_t *nodePtr;
...
const char *scale_scene_node(const char *node, point_t center,
                             scalar_t factor[3]) {
  scene_node_t *nodePtr;
  matrixgl_t matrix;
...
const char *transform_scene_node(const char *node, matrixgl_t mat,
                                 matrixgl_t invmat) {
  scene_node_t *nodePtr;
...
const char *set_scene_node_material(const char *node, const char *mat) {
  material_t *matPtr;
  scene_node_t *nodePtr;
...
const char *set_scene_node_shadow_state(const char *node, const char *state) {
  scene_node_t *nodePtr;
...
const char *set_scene_node_eye(const char *node, const char *which_eye) {
  scene_node_t *nodePtr;
...
const char *create_tranform_node(const char *parent_name,
...
const char *create_sphere_node(const char *parent_name, const char *child_name,
                               scalar_t resolution) {
  scene_node_t *node;
  char *msg;
  ...
  node->param.sphere.divisions =
      min(MAX_SPHERE_DIVISIONS,
          max(MIN_SPHERE_DIVISIONS,
...
const char *create_material(const char *mat, colour_t diffuse,
