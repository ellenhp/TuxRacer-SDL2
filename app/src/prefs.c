...
void update_music_volume(int button, int mouse_x, int mouse_y,
...
void update_sound_volume(int button, int mouse_x, int mouse_y,
                         widget_bounding_box_t bb, input_type_t input_type,
                         widget_t *widget) {
...
void update_graphics(int button, int mouse_x, int mouse_y,
                     widget_bounding_box_t bb, input_type_t input_type,
                     widget_t *widget) {
...
void update_view_mode(int button, int mouse_x, int mouse_y,
                      widget_bounding_box_t bb, input_type_t input_type,
                      widget_t *widget) {
...
void update_fps(int button, int mouse_x, int mouse_y, widget_bounding_box_t bb,
...
void prefs_select_cb(int button, int mouse_x, int mouse_y,
                     widget_bounding_box_t bb, input_type_t input_type,
                     widget_t *widget) {
  GameMenu_keypress(SDLK_RETURN);
}

void prefs_back_cb(int button, int mouse_x, int mouse_y,
                   widget_bounding_box_t bb, input_type_t input_type,
                   widget_t *widget) {
...
static void prefs_init(void) {
  ...
  gui_add_widget(
      prefs_back_button = create_button(get_back_text(), prefs_back_cb), NULL);
...
void prefs_register() {
  ...
  status |= add_keymap_entry(PREFS, DEFAULT_CALLBACK, NULL, NULL, prefs_key_cb);
