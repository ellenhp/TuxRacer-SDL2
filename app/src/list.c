...
/*!
  ...
  \return  the element after \c node in the list, of NULL if \c node is the last
  element \author  jfpatry \date    Created:  2000-08-14 \date    Modified:
  2000-08-14
*/
...
/*!
  ...
  \return  the element before \c node in the list, of NULL if \c node is the
  first element \author  jfpatry \date    Created:  2000-08-14 \date Modified:
  2000-08-14
*/
...
/*!
  ...
  \pre     llist != NULL
  \arg \c  llist the list
  \arg \c  node_before the new element should go after this one, or NULL if the
  new element should go at the front of the list \arg \c  new_data the data to
