...
#include "deps/tcl/generic/tclPort.h"
...
#include <string.h>
#endif
#if defined(STDC_HEADERS) || defined(__STDC__) || defined(__C99__FUNC__) || defined(__cplusplus) || defined(_MSC_VER) || defined(__ICC)
#include <stddef.h>
#else
...
#define TclIsVarDirectReadable(varPtr) \
	(!((varPtr)->flags & (VAR_ARRAY | VAR_LINK | VAR_TRACED_READ)) && (varPtr)->value.objPtr)
...
#define TclIsVarDirectModifyable(varPtr) \
	(!((varPtr)->flags & (VAR_ARRAY | VAR_LINK | VAR_TRACED_READ | VAR_TRACED_WRITE)) && (varPtr)->value.objPtr)
...
#else
#define TclGetIntFromObj(interp, objPtr, intPtr)                                                                                                                     \
	(((objPtr)->typePtr == &tclIntType && (objPtr)->internalRep.longValue >= -(Tcl_WideInt)(UINT_MAX) && (objPtr)->internalRep.longValue <= (Tcl_WideInt)(UINT_MAX)) \
		 ? ((*(intPtr) = (objPtr)->internalRep.longValue), TCL_OK)                                                                                                   \
		 : Tcl_GetIntFromObj((interp), (objPtr), (intPtr)))
#define TclGetIntForIndexM(interp, objPtr, endValue, idxPtr)                                                                        \
	(((objPtr)->typePtr == &tclIntType && (objPtr)->internalRep.longValue >= INT_MIN && (objPtr)->internalRep.longValue <= INT_MAX) \
		 ? ((*(idxPtr) = (objPtr)->internalRep.longValue), TCL_OK)                                                                  \
		 : TclGetIntForIndex((interp), (objPtr), (endValue), (idxPtr)))
#endif
...
#define TclGetWideIntFromObj(interp, objPtr, wideIntPtr)                            \
	(((objPtr)->typePtr == &tclIntType)                                             \
		 ? (*(wideIntPtr) = (Tcl_WideInt)((objPtr)->internalRep.longValue), TCL_OK) \
...
#define TclUtfToUniChar(str, chPtr)                                             \
	((((unsigned char)*(str)) < 0x80) ? ((*(chPtr) = (unsigned char)*(str)), 1) \
...
#define TclLimitReady(limit) \
	(((limit).active == 0) ? 0 : (++(limit).granularityTicker, ((((limit).active & TCL_LIMIT_COMMANDS) && (((limit).cmdGranularity == 1) || ((limit).granularityTicker % (limit).cmdGranularity == 0))) ? 1 : (((limit).active & TCL_LIMIT_TIME) && (((limit).timeGranularity == 1) || ((limit).granularityTicker % (limit).timeGranularity == 0))) ? 1 : 0)))
