...
static int angle_cb ( ClientData cd, Tcl_Interp *ip, int argc, const char *argv[]) 
{
    double angle;
...
static int bgnd_img_cb ( ClientData cd, Tcl_Interp *ip, int argc, const char *argv[]) 
{
...
// deprecated
*/
static int tree_tex_cb ( ClientData cd, Tcl_Interp *ip, int argc, const char *argv[]) 
{
...
static int ice_tex_cb ( ClientData cd, Tcl_Interp *ip, int argc,const char *argv[]) 
{
...
static int rock_tex_cb ( ClientData cd, Tcl_Interp *ip, int argc, const char *argv[]) 
{
...
static int snow_tex_cb ( ClientData cd, Tcl_Interp *ip, int argc, const char *argv[]) 
{
...
static int start_pt_cb ( ClientData cd, Tcl_Interp *ip, int argc, const char *argv[]) 
{
    double xcd, ycd;
...
static int elev_scale_cb ( ClientData cd, Tcl_Interp *ip, int argc, const char *argv[]) 
{
 ...
 */
static int
get_polyhedron_vertices(Tcl_Interp *ip, const char *arg, 
...
get_single_polygon(Tcl_Interp *ip, const char *arg, 
		   polygon_t *polygon)
{
  int i;
  const char **indices=0;
 ...
 */
static int
get_polyhedron_polygon(Tcl_Interp *ip, const char *arg, 
...
*/
static int 
tree_poly_cb(ClientData cd, Tcl_Interp *ip, int argc, const char *argv[]) 
{
  int           num_vertices;
  point_t     *vertices;
  int           num_polygons;
