...
tux_terrain $::course_dir/terrain.png        ;# bitmap specifying terrains type                              ;#     offset of 0 (integer from 0 - 255)tux_elev elev.png              ;# bitmap specifying course elevationstux_terrain terrain.png        ;# bitmap specifying terrains type
tux_course_init