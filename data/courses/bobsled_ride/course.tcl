...
tux_terrain $::course_dir/terrain.rgb        ;# bitmap specifying terrains type                              ;#     offset of 0 (integer from 0 - 255)tux_elev elev.rgb              ;# bitmap specifying course elevationstux_terrain terrain.rgb        ;# bitmap specifying terrains type
tux_course_init